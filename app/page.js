    ...
    <>
      <section className="mb-8">
        <div
          ...
          style={{ maskImage: 'url(/images/brush-mask.svg)', maskSize: 'contain', maskRepeat: 'no-repeat', maskPosition: 'center' }}
        >
          <Image
        ...
        <div className="md:after:block md:after:clear-both md:after:content-['']">
          <h1 className="font-serif text-3xl lowercase tracking-wide italic">
            frontend <span className="font-sans text-2xl font-normal not-italic">engineer</span>
          </h1>
          <p className="mt-3">
            Michael Hale is a frontend engineer and designer in Charlotte, N.C.
          </p>
          <p className="mt-3">
            He has experience with JavaScript, Elixir, and Ruby as well as React, Phoenix, and Rails. For more than ten years he has
            partnered with clients who share a commitment to creativity, integrity, and craft.
          </p>
        </div>
      </section>
      ...
      <section className="my-5">
        <h2 className="font-serif text-3xl lowercase tracking-wide italic">
          Recent <span className="font-sans text-2xl font-normal not-italic">Work</span>
        </h2>
      ...
      <p className="mt-6">
        Looking for more? <AppLink className="underline" href="/work/">View all projects.</AppLink>
      </p>
    </>
  );
}
